    ...
    <div class="small-12 medium-12 cell">
      ...
      <table class="hover" data-form="deleteForm">
        <tbody>
          ...
          <tr>
            <td>
              <img src="<?php echo $_SERVER["APP_URL"] ?>/{{ $product['image_path'] }}" alt="{{ $product['name'] }}" height="40" width="40">
            </td>
            <td>{{ $product["name"] }}</td>
            <td>{{ $product["price"] }}</td>
            ...
            <td width="100" class="text-right">
              ...
              <span data-tooltip tabindex="1" title="Edit Product">
                <a href="<?php echo $_SESSION ?>/admin/product/{{ $product['id'] }}/edit"><i class="fa fa-edit"></i></a>
              </span>
              <!--/Edit button-->
